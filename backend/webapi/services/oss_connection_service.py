...
from common.db.models import OSSConnection, OSSConnectionShare
from common.schemas.oss_connection import OSSConnectionCreate, OSSConnectionUpdate, ShareOSSConnectionIn, ShareTeamBuckets
from typing import List, Optional
from datetime import datetime
from common.core.encryption import encrypt_api_key, decrypt_api_key
...
def test_oss_connection(endpoint: str, access_key: str, secret_key: str, region: Optional[str] = None) -> tuple[bool, str]:
    try:
        client = OSSClient(endpoint, access_key, secret_key, region)
        client.list_buckets()
        return True, ""
